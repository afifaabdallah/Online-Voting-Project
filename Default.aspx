...
<body>
    ...
    <form id="loginform" runat="server">
        ...
        <nav class="teal" role="navigation">
            <div class="nav-wrapper container">
                <a id="logo-container" href="Default.aspx" class="brand-logo">OnLineVote</a>
    ...
    <div id="index-banner" class="parallax-container">
        <div class="section no-pad-bot">
            <div class="container">
                <br/><br/>
                <h1 class="header center white-text">OnLineVote</h1>
                <div class="row center">
                    <h5 class="header col s12 light">An Online Voting Portal for FivePoint</h5>
                </div>
                <div class="row center">
